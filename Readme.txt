...
AuxFunc file contains a linear congruence function to generate random numbers based on a seed the user passes as an argument. To run the game please download both R files to the same directory.
